...
from config.config_manager import write_config
try:
    from repositories.store import list_resumes_doc as _store_list, write_resumes_doc as _store_write  # type: ignore
except ImportError:
    _store_list = None
    _store_write = None
